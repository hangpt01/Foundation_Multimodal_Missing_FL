...
class Server(BasicServer):
    ...
    def aggregate(self, models: list):
        ...
        for k in range(n_models):
            self.clients[self.selected_clients[k]].local_model.complete_prompt = new_model.complete_prompt
            self.clients[self.selected_clients[k]].local_model.missing_text_prompt = new_model.missing_text_prompt
            self.clients[self.selected_clients[k]].local_model.missing_img_prompt = new_model.missing_img_prompt
