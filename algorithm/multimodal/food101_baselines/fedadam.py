...
class Server(BasicServer):
    ...
    def aggregate(self, models: list, beta1=0.9, beta2=0.999, epsilon=1e-8, m=None, v=None):
        ...
        for k in global_dict.keys():
            ...
            new_model.img_fc.v[k] = beta2 * new_model.img_fc.v[k] + (1 - beta2) * updates.pow(2)
        ...
        for k in global_dict.keys():
            ...
            new_model.text_fc.v[k] = beta2 * new_model.text_fc.v[k] + (1 - beta2) * updates.pow(2)
        ...
        for k in global_dict.keys():
            ...
            new_model.attention.v[k] = beta2 * new_model.attention.v[k] + (1 - beta2) * updates.pow(2)
