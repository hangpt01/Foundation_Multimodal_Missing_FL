...
# wget --load-cookies /tmp/cookies.txt "https://docs.google.com/uc?export=download&confirm=$(wget --quiet --save-cookies /tmp/cookies.txt --keep-session-cookies --no-check-certificate 'https://docs.google.com/uc?export=download&id=1XJDQAYagmxrK5a2Qm2Jl2Yt2n_vorub4' -O- | sed -rn 's/.*confirm=([0-9A-Za-z_]+).*/\1\n/p')&id=1XJDQAYagmxrK5a2Qm2Jl2Yt2n_vorub4" -O ./benchmark/RAW_DATA/FOOD101/food101_train.arrow && rm -rf /tmp/cookies.txt

# gdown --id 1MSwt-tIXb5QWo1kbQ9PJqflm6XarpTsh
# gdown --id 1BP1TiVRlKZCcaJDG7wkUZnhtZs1rThYT
# gdown --id 1XJDQAYagmxrK5a2Qm2Jl2Yt2n_vorub4

# gdown --no-cookies 1MSwt-tIXb5QWo1kbQ9PJqflm6XarpTsh