...
class TaskPipe(IDXTaskPipe):
    ...
    def load_task(cls, task_path):
        ...
        for name in feddata['client_names']:
            ...
            # import pdb; pdb.set_trace()
            missing_rates_list.append(feddata[name]['missing_rate'])

        test_data = (test_data, other_test_datas)
        return train_datas, test_data, feddata['client_names'], missing_rates_list
...
def save_task(generator):
    ...
    for cid in range(len(generator.cnames)):
        # print(cid)
        # import pdb; pdb.set_trace()
        if generator.missing_rates:
            feddata[generator.cnames[cid]] = {
                'missing_rate': generator.missing_rates[cid],
...
class TaskGen(DefaultTaskGen):
    def __init__(self, dist_id, num_clients=1, skewness=0.5, local_hld_rate=0.0, seed=0, missing=False, missing_ratio_train=0.7, missing_ratio_test=0.7, missing_type_train='both', missing_type_test='both', both_ratio=0.5, max_text_len=40):
        super(TaskGen, self).__init__(benchmark='imdb_classification_random',
                                      dist_id=dist_id, 
        ...
        self.source_dict = {
            'class_path': 'benchmark.imdb_classification_random.dataset',
        ...
        self.missing_rates = [(0.8, 2), (0.9, 2), (0.2, 2), (1.0, 2), (0.5, 2),  (0.7, 2), 
                                (0.6, 1), (1.0, 1), (0.2, 1), (0.8, 1), (0.7, 1), (0.9, 1), 
                                (0.4, 0), (0.7, 0), (0.1, 0), (0.8, 0), (0.3, 0), (0.5, 0), (1.0, 0), (0.9, 0)]
