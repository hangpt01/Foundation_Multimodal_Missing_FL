...
if __name__=='__main__':
    ...
    # data_loader = DataLoader(my_dataset, batch_size=40, shuffle=True, collate_fn=my_dataset.collate) # len: 61127 - batch1; 1529 0 batch 40
                                                                                                    # test:22716                    
# Iterate over the dataset and print a sample
    ...
    #     print(batch)
    #     import pdb; pdb.set_trace()
    data_loader = DataLoader(my_dataset, batch_size=40, shuffle=True, collate_fn=collate) # len: 61127 - batch1; 1529 0 batch 40
