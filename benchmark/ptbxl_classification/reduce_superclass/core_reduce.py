from .dataset_reduce import PTBXLReduceDataset
...
class TaskGen(DefaultTaskGen):
    def __init__(self, dist_id, num_clients=1, skewness=0.5, local_hld_rate=0.0, seed=0, missing_2_6=False, missing_all_6=False, missing_1_12=False, missing_6_10=False, missing_rate=-1, missing_ratio_2_modal=-1):
        ...
        if self.missing_all_6:
            ...
            self.taskname = self.taskname + '_missing_6_10'
            self.taskpath = os.path.join(self.task_rootpath, self.taskname)
        else:
            ...
            self.taskname = self.taskname + '_missing_2_6'
            self.taskpath = os.path.join(self.task_rootpath, self.taskname)
