...
class Model(FModule):
    def __init__(self, prompt_method="shallow", batchwise_prompt=True, classification_adaptor=True,
                 pool_size=20, top_k=10, frozen_pretrain=True, num_classes=101):
    ...
    #     self.trained_prompts_checklist
